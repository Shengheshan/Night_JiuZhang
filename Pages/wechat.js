...
const REPORTER_STORY_TURNS = [
  ...
  { sender: 'them', text: '我一开始也没有往阴谋的方向去想，只是把这些意外归咎于九章山的登山步道缺乏安全保护措施。直到去年九月。' },
  ...
  { sender: 'them', text: '后面几起案件也同理，受害人的额头都有这个印记。' },
  ...
  { sender: 'them', text: '凶手的作案规律，挑选受害人的规律，这个印记的含义等等，我都没有任何头绪。' },
  { sender: 'them', text: '我只能说，不管凶手是谁，他一定都拥有很大的能量。' },
  { sender: 'them', text: '你也注意到了，警察，法医，没有一个人说出这些异常。我不信他们都没有注意到' },
  { sender: 'me', text: '。。。。。' },
  { sender: 'me', text: '我相信你。' },
